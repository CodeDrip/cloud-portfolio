...
const SOCIAL_LINKS = [
  { icon: LinkedInIcon, href: "https://www.linkedin.com/in/dhaesha/", label: "LinkedIn" },
  { icon: GitHubIcon, href: "https://github.com/CodeDrip", label: "GitHub" },
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          <SectionReveal direction="left" className="w-full lg:w-[60%]">
            <GlassCard padding="lg">
              ...
              {submitted && (
                <div className="mb-6 p-4 rounded-xl bg-[rgba(236,72,153,0.1)] border border-[rgba(236,72,153,0.2)] text-[#ec4899] text-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <textarea placeholder="Your Message" rows={5} value={formData.message}
                  ...
                  className="form-input resize-vertical" required />
                <button type="submit" className="submit-button">Send Message</button>
              </form>
            </GlassCard>
          </SectionReveal>

          <SectionReveal direction="right" className="w-full lg:w-[40%]">
            <div className="lg:pt-4">
              <h2 className="text-[clamp(2rem,5vw,3.5rem)] font-light leading-[1.2] tracking-[-0.01em] uppercase text-white mb-6">
                Let&apos;s Connect
              </h2>
